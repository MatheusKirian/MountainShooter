...
from Codes.Const import MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, EVENT_TIMEOUT, COLOR_WHITE, WIN_HEIGHT, TIMEOUT_LEVEL, \
    TIMEOUT_STEP
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(14, f'Player1 - Health: {ent.health} | Score: {ent.score}', (0, 128, 0), (10, 25))
                if ent.name == 'Player2':
                    self.level_text(14, f'Player2 - Health: {ent.health} | Score: {ent.score}',(0, 128, 128), (10, 45))
